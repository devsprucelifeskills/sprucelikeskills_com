      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-10 pb-8 border-b border-[#1b5c3e]">
          ...
          <div className="flex items-center gap-6">
            ...
            <button className="bg-[#FDB813] text-black text-sm font-bold py-2.5 px-6 hover:bg-[#e6a510] transition-colors">
              Enquire Now
            </button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-1">
              ...
              <img src="https://images.unsplash.com/photo-1541339907198-e08756dedf3f?auto=format&fit=crop&q=80&w=80&h=80" alt="Gallery 2" className="w-[50px] h-[70px] sm:w-[55px] sm:h-[75px] object-cover" />
              <img src="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?auto=format&fit=crop&q=80&w=80&h=80" alt="Gallery 3" className="w-[50px] h-[70px] sm:w-[55px] sm:h-[75px] object-cover" />
              <img src="https://images.unsplash.com/photo-1576091160550-2173ff9e5ee5?auto=format&fit=crop&q=80&w=80&h=80" alt="Gallery 4" className="w-[50px] h-[70px] sm:w-[55px] sm:h-[75px] object-cover" />
            </div>
          </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-center pt-6 border-t border-[#1b5c3e] relative">
          <button className="bg-[#FDB813] text-black text-xs font-bold py-2.5 px-6 hover:bg-[#e6a510] transition-colors mb-4 md:mb-0 md:-ml-4">
            Enquire Now
          </button>
