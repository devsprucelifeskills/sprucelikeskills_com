    ...
    <section className="relative overflow-hidden bg-gradient-to-b from-emerald-50 to-white py-24 sm:py-32">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8 relative">
        <div className="mx-auto max-w-2xl text-center">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-emerald-100/50 border border-emerald-200 mb-6 group hover:bg-emerald-100 transition-colors">
            <Rocket className="w-4 h-4 text-emerald-600 group-hover:scale-110 transition-transform" />
            <span className="text-xs font-bold text-emerald-700 uppercase tracking-widest">Our Purpose</span>
          </div>
          <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl mb-6">
            Empowering Through <span className="bg-clip-text text-transparent bg-gradient-to-r from-emerald-600 to-teal-600">Excellence</span>
          </h1>
        ...
        <div className="grid grid-cols-1 gap-8 mt-16 sm:grid-cols-2">
          ...
          <div className="relative group p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-100 shadow-sm hover:shadow-2xl hover:bg-white transition-all duration-500 overflow-hidden">
            <div className="absolute top-0 right-0 -mr-4 -mt-4 w-24 h-24 bg-emerald-50 rounded-full blur-2xl group-hover:bg-emerald-100 transition-colors" />
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 bg-[#13523f] rounded-2xl shadow-lg shadow-emerald-200 group-hover:scale-110 transition-transform">
          ...
          {/* Vision Card */}
          <div className="relative group p-8 bg-white/60 backdrop-blur-sm rounded-3xl border border-gray-100 shadow-sm hover:shadow-2xl hover:bg-white transition-all duration-500 overflow-hidden">
            <div className="absolute top-0 right-0 -mr-4 -mt-4 w-24 h-24 bg-teal-50 rounded-full blur-2xl group-hover:bg-teal-100 transition-colors" />
            <div className="flex items-center gap-4 mb-6">
              <div className="p-3 bg-[#0A3D24] rounded-2xl shadow-lg shadow-emerald-200 group-hover:scale-110 transition-transform">
