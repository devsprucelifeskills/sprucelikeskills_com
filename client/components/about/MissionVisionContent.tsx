      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div className="relative">
            <div className="absolute -top-4 -left-4 w-24 h-24 bg-blue-50 rounded-full blur-3xl opacity-60" />
            <h2 className="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-6">
              Building Careers in <span className="text-blue-600">Health Sciences</span>
            </h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {impactPoints.map((point, i) => (
              <div 
                key={i} 
                className="p-6 rounded-2xl bg-slate-50 border border-slate-100 group hover:bg-blue-600 hover:-translate-y-1 transition-all duration-300"
              >
                <point.icon className="w-8 h-8 text-blue-600 group-hover:text-white mb-4 transition-colors" />
                <h3 className="text-lg font-bold text-gray-900 group-hover:text-white mb-2 transition-colors">{point.title}</h3>
                <p className="text-sm text-gray-600 group-hover:text-blue-50 transition-colors leading-relaxed">{point.desc}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div className="mt-24 rounded-[2rem] bg-slate-900 p-8 sm:p-12 lg:p-16 relative overflow-hidden">
          ...
          <div className="relative text-center max-w-3xl mx-auto">
            ...
            <div className="mt-10 inline-flex flex-wrap justify-center gap-8 border-t border-slate-800 pt-10">
              ...
              <div className="text-center">
                <p className="text-3xl font-bold text-blue-400">AAPC</p>
