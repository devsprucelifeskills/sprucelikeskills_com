    ...
    return (
        <section id="home" className="w-full relative bg-background overflow-hidden">
            <div
                ...
                style={{
                    background: 'radial-gradient(circle at top left, rgba(0, 122, 86, 0.94), transparent 45%), radial-gradient(circle at bottom right, rgba(104, 185, 160, 0.84), transparent 45%)'
                }}
            />
            <div className="relative z-10 container text-center pt-28 pb-20 md:pb-28">
                <div className="max-w-4xl mx-auto">
                    <div className="mb-12">
                        <h1 className="mb-6 mx-auto font-serif text-center text-5xl md:text-[4rem] font-extrabold leading-[1.1] tracking-tight text-[#1a1a1a]">
                            Without <span className="text-[#005a9c]">Skills</span>, Your <br className="hidden md:block" />
                            <span className="text-[#005a9c]">Degree</span> Is Not Enough <br className="hidden md:block" />
                            Anymore.
                        </h1>
                        <p className="text-body-lead text-muted-foreground max-w-2xl mx-auto text-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        <Button asChild size="xl" className='w-full sm:w-auto bg-[#13523f] hover:bg-[#0f3f30] text-white border-0 shadow-lg'>
