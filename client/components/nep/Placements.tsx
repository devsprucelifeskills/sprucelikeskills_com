            ...
            <div className="container">
                <div className="flex flex-col items-center gap-8">
                    ...
                    <div className="w-full inline-flex flex-nowrap overflow-hidden [mask-image:_linear-gradient(to_right,transparent_0,_black_128px,_black_calc(100%-128px),transparent_100%)]">
                        <ul className="flex items-center justify-center md:justify-start [&_li]:mx-8 animate-scroll shrink-0">
                        ...
                        <ul className="flex items-center justify-center md:justify-start [&_li]:mx-8 animate-scroll shrink-0" aria-hidden="true">
                            {companies.map((company, index) => (
                                <li key={index} className="relative h-20 w-40">
                                    <Image
                                        src={company.logo}
