        ...
        <ScrollReveal animation="fade-in">
          <div className="flex justify-between items-end mb-10">
            ...
            <div className="hidden sm:flex gap-2">
              <button
                onClick={scrollLeft}
                className="bg-[#FDB813] p-2 hover:bg-[#e6a510] transition-all rounded shadow-sm"
                  ...
                  <div className="text-left">
                    ...
                    <div className="flex gap-0.5">
                      {[1, 2, 3, 4, 5].map((_, starIdx) => (
                        <Star key={starIdx} className={`w-3.5 h-3.5 ${starIdx < 4 ? 'fill-[#FDB813] text-[#FDB813]' : 'fill-gray-100 text-gray-100'}`} />
                      ))}
                    </div>
                  </div>
                  <Link 
