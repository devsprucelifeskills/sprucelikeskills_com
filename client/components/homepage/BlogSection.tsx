      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <ScrollReveal animation="fade-up">
          <div className="flex flex-col items-center mb-16">
            ...
            <div className="w-24 h-1.5 bg-[#FDB813] rounded-full"></div>
          </div>
        </ScrollReveal>
        ...
        <ScrollReveal animation="fade-in" delay={200}>
          <div className="relative flex items-center justify-center min-h-[500px]">
            ...
            <div className="absolute top-1/2 -translate-y-1/2 left-0 right-0 z-30 flex justify-between px-2 md:px-0">
              <button
                onClick={scrollLeft}
                className="bg-white p-3 rounded-full shadow-xl hover:bg-[#FDB813] transition-all group border border-gray-100"
              ...
              <div className="flex-shrink-0 w-full max-w-sm sm:max-w-md lg:max-w-lg z-20 transform transition-all duration-500 hover:scale-[1.01]">
                <div className="bg-white rounded-2xl shadow-[0_20px_40px_-12px_rgba(0,0,0,0.12)] border border-gray-50 overflow-hidden flex flex-col">
                  ...
                  <div className="relative h-48 md:h-52 overflow-hidden">
                    ...
                    />
                    <div className="absolute top-3 left-3 bg-[#FDB813] text-black text-[9px] font-black px-2.5 py-0.5 rounded-full uppercase tracking-tighter">
                      Featured
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-[#0A3D24] via-[#0D5232] to-[#126B41] p-6 text-white text-center">
                    <div className="flex items-center justify-center gap-2 mb-3">
                      <span className="w-6 h-0.5 bg-[#FDB813]"></span>
                      <span className="text-[10px] font-black uppercase tracking-widest text-[#FDB813]">{current.category}</span>
                      <span className="w-6 h-0.5 bg-[#FDB813]"></span>
                    </div>
                  ...
                  <div className="p-4 bg-white border-t border-gray-100 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      <div className="bg-[#FDB813] text-black w-12 h-12 rounded-xl flex flex-col items-center justify-center shadow-md">
                    ...
                    <Link href={`/blog/${current.slug}`} className="p-2.5 bg-gray-50 hover:bg-[#FDB813] rounded-full transition-colors group shadow-sm">
